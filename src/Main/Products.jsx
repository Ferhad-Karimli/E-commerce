  ...
  <>
      ...
      {!detailedmode ? null : (
        <div className={style.drop_detailed}>
          <Detailed products={props.productsInfo}
    ...
    <span className="product--title__small">{nameRest.join(" ")}</span>
            ...
            {count > 0 ?<div className={ style.after_click}>
              ...
              <div className={style.plus}>
                <BiPlus
                  ...
                  onClick= {() =>
                    {props.addBasket(count,props.productsInfo.id,props.productsInfo.price);
          ...
          <Link
            to={`/e-commerce/detailed/${props.productsInfo.id}`}
          >
